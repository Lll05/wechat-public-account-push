export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "wxab19671f6368dd7b",

  // 公众号APP_SECRET
  APP_SECRET: "a71ad863311f508e96c7244e9208cf6e",
  ...
  USERS: [
    {
      ...
      name: "老婆0",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "ouUBF6AEu6qHlKYYABLDPssmZCn8",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "YcxPK4iKdH0RYkqM-FvO_tKcHqArHOxD2QWHpWOXczE",
      // 他点击详情后跳转的页面,你可以设置成微博的热榜，也可以设置成其他，网址一定要填对；不填对也没关系，随便你，会打不开而已。
      openUrl: "https://wangxinleo.cn"
    }, 
    {
  ...
  CALLBACK_TEMPLATE_ID: "	YcxPK4iKdH0RYkqM-FvO_tKcHqArHOxD2QWHpWOXczE",
